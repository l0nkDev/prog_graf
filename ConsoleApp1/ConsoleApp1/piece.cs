    ...
    public class Piece
    {
		...
		public void Draw(Shader shader, Matrix4 model, Matrix4 view, Matrix4 projection, double time)
		{
            ...
            { 
			    ...
			    {
				    face.Draw(shader, Matrix4.CreateScale(scale_x, scale_y, scale_z) * roll * pitch * yaw * Matrix4.CreateTranslation(offset_x, offset_y, offset_z) * model, view, projection, time);
			    }
            }
        }
